...
> [!NOTE]
> This is the legacy standalone patcher for GK2 Display Tweaks.
>
> The patcher directly modifies `Assembly-CSharp.dll` and has been
> superseded by the BepInEx-based plugin.
>
> It is kept in this repository for reference and is no longer the
> recommended installation method.
>
> See the [main README](../README.md) for the current version.
